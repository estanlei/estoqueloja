...
using ESTOQUELOJA.DAO.Automapper;
using System.Collections.Generic;
using System.Data.Entity.Core.Objects;
using System.Data.Entity.Infrastructure;
using System;

namespace ESTOQUELOJA.DAO.Generic
{
    public class GenericMapperDAO<T, D, Id>  where T : class
    {
        ...
        public object[] GetPropertyValue(D source)
        {
            ...
            {
                if (attr is GenericAttribute)
                {
                    GenericAttribute a = (GenericAttribute)attr;
                    var index  = 0;
